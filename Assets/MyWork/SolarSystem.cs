...
public class SolarSystem : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < solarBodiesCSV.Length; i++)
        {
            ...
            planetProperties[i].actualPosition = new Vector3(solarBodiesCSV[i].distance, solarBodiesCSV[i].distance, solarBodiesCSV[i].distance);
            planetProperties[i].velocity = new Vector3(solarBodiesCSV[i].initial_velocity, solarBodiesCSV[i].initial_velocity, solarBodiesCSV[i].initial_velocity);
